...
#define WNI_CFG_SKIP_CRASH_INJECT_STAMIN   0
...
#define WNI_CFG_SAP_ENABLE_BEACON_FILTER_STAMIN 0
#define WNI_CFG_SAP_ENABLE_BEACON_FILTER_STAMAX 1
#define WNI_CFG_SAP_ENABLE_BEACON_FILTER_STADEF 0
